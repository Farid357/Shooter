...
{
    public sealed class SwitchingRightGoodAction : ISwitchingGoodAction
    {
        private readonly IGoodSwitchingView _goodSwitchingView;
        private readonly IEnumerable<IGood> _goods;

        public SwitchingRightGoodAction(IGoodSwitchingView goodSwitchingView, IEnumerable<IGood> goods)
        {
        ...
        public bool CanSwitch(int index) => _goods.Count() > index;
    }
}